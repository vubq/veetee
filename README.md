...
activation/bootstrap, WebSocket V1, raw Opus hai chiều và voice-server cascade local.
Manager API/Web vẫn đang được hoàn thiện theo roadmap; toàn hệ thống chưa phải bản
production.
