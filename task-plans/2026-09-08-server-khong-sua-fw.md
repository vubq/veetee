...
- Verification 2026-09-10: bước 1–4 vẫn PASS trên suite 154; bước 5 E2E runtime PASSED ("Mấy giờ rồi." → đáp đúng giờ, first binary ~1.9s); bước 6 hardware PARTIAL — board thật (wifi-lcd, FW build Kconfig từ baseline, OTA local): OTA 200, wake EN, 1 lượt hỏi/đáp acoustic, idle-close + re-wake đã PASS; abort vật lý/interrupt 20x20, tail dài, speaker-stop đo đạc vẫn PENDING. Bước 7 (barge-in option) chưa mở, giữ `client_only`. Giữ `PARTIAL`.
