...
- ST7789 init 240x320, offset 0/0 và gửi color bars thành công ở driver level;
- I2S simplex mic 16 kHz left slot + speaker 24 kHz khởi tạo thành công;
- startup chime hai nốt ghi xong; mic trả 16.000 sample/giây, signal thay đổi và chưa clipping;
...
User báo panel chưa hiển thị dù driver không trả lỗi. Profile breadboard hiện giảm
SPI từ 40 MHz xuống 10 MHz và đưa mode 0--3 vào Kconfig; cần xác nhận lại bằng mắt,
sau đó mới test backlight polarity, mode 3 hoặc panel geometry. Không coi log
`Color bars rendered` là bằng chứng panel đã nhận dữ liệu vì ST7789 write-only
không có readback trong wiring hiện tại.
