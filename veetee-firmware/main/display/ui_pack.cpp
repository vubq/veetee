...
UiTheme BuiltInSignalTheme() {
    ...
    const std::array<UiStateStyle, 13> styles = {{
        {0x1166, 0xFFDE, 0xCF8D}, {0x1166, 0xFFDE, 0x7F1A},
        {0x1166, 0xFFDE, 0x7F1A}, {0x1166, 0xFFDE, 0xCF8D},
        {0x1166, 0xFF9D, 0xF327}, {0x1166, 0xFFDE, 0xCF8D},
        {0x1166, 0xFFDE, 0x7F1A}, {0x1166, 0xFFDE, 0xCF8D},
        {0x1166, 0xFFDE, 0xF5EA}, {0x1166, 0xFFDE, 0xF5EA},
        {0x1166, 0xFF9D, 0xCF8D}, {0x1166, 0xFF9D, 0xF327},
        {0x1166, 0xFFDE, 0x7F1A},
    }};
    theme.states = styles;
    return theme;
}
