...
export const fixtureSchemaIds = {
  ...
  "artifacts/resource-config-link-v1.json": "https://schemas.veetee.local/artifacts/resource-manifest-v1.json",
  ...
  "config/device-config-v1.json": "https://schemas.veetee.local/config/device-config-v1.json",
  "config/device-config-wake-audio-v1.json": "https://schemas.veetee.local/config/device-config-v1.json",
  "config/agent-prompt-minimal-v1.json": "https://schemas.veetee.local/config/agent-prompt-config-v1.json",
  "config/agent-prompt-config-v1.json": "https://schemas.veetee.local/config/agent-prompt-config-v1.json",
  ...
  "devices/reported-config-state-v1.json": "https://schemas.veetee.local/devices/reported-state-v1.json",
  "lab/abort-v1.json": "https://schemas.veetee.local/lab/websocket-v1.json",
  "lab/audio-start-v1.json": "https://schemas.veetee.local/lab/websocket-v1.json",
  "lab/auth-v1.json": "https://schemas.veetee.local/lab/websocket-v1.json",
  "lab/create-session-request-v1.json": "https://schemas.veetee.local/lab/session-rest-v1.json",
  "lab/create-session-response-v1.json": "https://schemas.veetee.local/lab/session-rest-v1.json",
  "lab/event-admission-v1.json": "https://schemas.veetee.local/lab/websocket-v1.json",
  "lab/hello-text-v1.json": "https://schemas.veetee.local/lab/websocket-v1.json",
  "lab/text-input-v1.json": "https://schemas.veetee.local/lab/websocket-v1.json",
