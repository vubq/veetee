...
export const agentPromptConfigSchema = {
  ...
  properties: {
    ...
    personalityPresetId: { type: "string", minLength: 1, maxLength: 80 },
    personalityLabel: { type: "string", minLength: 1, maxLength: 120 },
    personality: { type: "string", minLength: 1, maxLength: 8_000 },
