...
class ConversationPolicy:
    ...
    llm_first_token_seconds: float = 5.0
    llm_stream_idle_seconds: float = 20.0
    llm_total_seconds: float = 0.0
    tts_first_audio_seconds: float = 5.0
    tts_stream_idle_seconds: float = 10.0
    ...
    speech_chunk_target_characters: int = 48
    speech_chunk_max_characters: int = 160
    llm_delta_max_characters: int = 16_384
